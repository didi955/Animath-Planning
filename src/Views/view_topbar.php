<nav class="d-flex mb-3 navbar bg-body-tertiary bg-white">
    <div class="container-fluid">
        ...
        <a class="ms-auto p-1 nav-item" role="button" aria-expanded="true" aria-controls="collapseMenu" data-bs-toggle="collapse" data-bs-target="#collapseMenu" alt="mon_compte" >
