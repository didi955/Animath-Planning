...
class ReservationController extends Controller
{
    ...
    public function action_filter()
    {
        ...
        if(isset($_POST['stud_level']) && isset($_POST['meeting-time_start']) && isset($_POST['meeting-time_end'])){
            ...
            $this->render("myAccount",['user' => unserialize($_SESSION['user']), 'stand' => StandModel::getModel()->getAllStand(), 'activities' => $activities, 'student_level' => $_POST['stud_level'],  $_SESSION['user']]);
        }
        else {
