...
<h3 class="fw-bold fs-4">Article 1 : Mention légale</h3>
<p>
    Le site d’inscription au salon culture et jeux mathématiques, inscription.salon-math.fr, est la propriété de l’association Animath – IHP domicilié au 11-13 Rue Pierre et Marie Curie, 75231 Paris Cedex 05.
    <br>
    Le bureau administratif d’Animath est ouvert du lundi au vendredi de 9h à 13h et de 14h à 17h.
    <br>
    Pour toute question contacter : <a href="https://salon-culture-jeux-maths@animath.fr">salon-culture-jeux-maths@animath.fr</a>
    <br>
</p>
<p class="text-decoration-underline">Hebergeur:</p>
...
<p>
    Le site <a href="https://insciption.animath.fr">inscription.salon-math.fr</a>, a pour objectif l’inscription autonome des enseignant·es, accompagnés de groupes scolaires, souhaitant se rendre au Salon Culture et Jeux Mathématiques ayant lieu le dernier weekend de mai, Place Saint Sulpice, Paris 75006.
...
<h3 class="fw-bold fs-4">Article 3: Les droits et les obligations de l’éditeur</h3>

<p>
    Le site <a href="https://insciption.animath.fr">inscription.salon-math.fr</a> et l’association Animath mettent tout en œuvre pour offrir aux utilisateurs un site accessible 24 heures sur 24 et 7 jours sur 7, à l’exception des cas de force majeure et difficultés techniques ou informatiques. Le site s’engage également à ne publier que des informations et/ou des outils vérifiés, mais ne saurait être tenu responsable des erreurs, d’une absence de disponibilité des informations et/ou de la présence de virus sur son site.
    ...
    Le site <a href="https://insciption.animath.fr">inscription.salon-math.fr</a>, s’engage à ne pas partager les informations données par l’utilisation lors de la création de son compte personnel enseignant·e.
</p>

<h3 class="fw-bold fs-4">Article 4: Les droits et les obligations de l’utilisateur</h3>

<p>
    L’utilisateur s'engage lors de l'inscription à fournir des informations exactes et à maintenir confidentiels ses identifiants de connexion. L’utilisateur s’engage également à ne pas tenter de nuire au bon fonctionnement du site  <a href="https://insciption.animath.fr">inscription.salon-math.fr</a>,  en respectant les règles d’utilisation du présent site. En cas de non-respect des règles ci-dessus, le compte enseignant·e de l’utilisateur sera supprimé et ses réservations annulées.
...
<h3 class="fw-bold fs-4">Article 5: Propriété intellectuelle</h3>

<p>
    La structure générale, les logiciels, textes, images, vidéos, sons, et plus généralement toutes autres informations et contenus figurant dans le site <a href="https://insciption.animath.fr">inscription.salon-math.fr</a>, sont la propriété d’Animath font l’objet d’une protection par le code de la protection intellectuelle et plus particulièrement soumis à la législation protégeant le droit d’auteur.
...
<h3 class="fw-bold fs-4">Article 6: Liens hypertextes et contenus intégrés</h3>
...
<h3 class="fw-bold fs-4">Article 7: Cookies</h3>
...
<h3 class="fw-bold fs-4">Article 8: Droit applicable et juridiction compétente</h3>
